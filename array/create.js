...
const arr2 = [1, 2, 3, 4, 5] //Create an array 
...
//Traverse the array using an enchanced for loop (for...of)
for (const num of arr2) {
    console.log(num); //Accessing array elements using enchanded for loop
}
...
arr2.forEach(console.log); //Using forEach with consolo.log directly